...
Some other useful spack commands on the repository.
We shall clone the lab in order to complete it.
---
...
$$
(This formula is partly wrong.)
![bg left 85%](img/grid.png)

---
# Application: 2D heat equation
## Halo exchange
We need to know the boundary conditions on the other boundary (not owned DoFs that are still necessary)
...
# Compilation
You can find it in the Jupyter Notebook.
