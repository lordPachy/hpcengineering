...
### Wildcards
A wildcard is a character (or set of characters) that in a command matches one or more characters. It is really useful for searching a file (maybe you know just its extension) or applying a command to a subset of files (maybe you want to copy onwget https://math.nist.gov/pub/MatrixMarket2/NEP/mhd/mhd416a.mtx.gzly files starting with `2023-`).
