...
DiffusionReactionParallel::output() const
{
  ...
  // VTU: file containing single-thread information
  // PVTU: extra file containing the aggregate info
  // This file should always be kept in the same folder.
  // Moreover, they need to be uploaded separately on ParaView,
  // or we can just open the pvtu

  // Index is useful for time-dependent data
