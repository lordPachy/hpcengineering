...
// New includes for supporting parallel computing
#include <deal.II/distributed/fully_distributed_tria.h>
#include <deal.II/distributed/
...
public:
  ...
  DiffusionReaction(const std::string  &mesh_file_name_,
    ...
    , sigma(sigma_)
    , f(f_)
    // We need to give information to MPI
...
protected:
  ...
  // Triangulation.
  parallel::fullydistributedTriangulatiom<dim> mesh;
